  ...
  return (
    <div className='fixed left-4 bottom-4 flex items-center justify-center
     overflow-hidden md:right-8 md:left-auto md:top-0 md:bottom-auto md:absolute'>
        <div className='w-56 h-auto flex items-center justify-center relative md:w-24'>
            <CircleComp className={"fill-dark animate-spin-slow dark:fill-light"}/>
            <Link href="mailto:abenapoku02@gmail.com" className='flex items-center justify-center
